...
from sklearn.ensemble import RandomForestClassifier
'''
rfc = RandomForestClassifier(n_estimators=10, criterion = 'gini', random_state=250)
...
def CalcKFold(ML_AlgorithmName, ML_Algorithm, K_Value):
    ...
    # kFold Katlamalı Dizilerin Sonuçları
    #print("Accuracy Dizisi : " + str(scores['test_accuracy']))
    #print("Recall Dizisi : " + str(scores['test_recall']))
    #print("Precision Dizisi : " + str(scores['test_average_precision']))
    #print("F1 Score Dizisi : " + str(scores['test_f1']))
...
'''
connection = pyodbc.connect('Driver={SQL Server}; Server=10.34.150.77,10555; Database=DBKACAK; uid=mustafa.celikpence; pwd=yA3JR5r7; ')
...
#TesisatNo = KacakTahminVerileri.iloc[0,0:1].values;
...
# penalty : none / Inverse of regulation strength: 1.0 / 
...
'''
# 3.2 KNN
# n_neighbors - Number of neighbors =1 / weight function : 'uniform' / metric - distance metric ='minkowski'
...
#svc = SVC(kernel='poly')
#svc = SVC(kernel='rbf', probability=True, random_state=250)
...
# y_predload = Load_SVM_Model.predict(XStd_Test)
#end = time()
...
'''
# 5. Random Forest
# n_estimators - The number of trees in the forest: 10 / criterion - fonksiyon= 'gini' / 
...
# 5.1. Random Forest GridSearch https://www.kaggle.com/cesartrevisan/scikit-learn-and-gridsearchcv
# 
'''
